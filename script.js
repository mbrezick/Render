...
const ivrPhoneNumber = "1-412-388-9229"

//This is the URL for starting a SMS conversations with WxConnect
const sendSMSWelcomeWebhook = "https://hooks.us.webexconnect.io/events/FCQVL762HC"

//This is the URL for requesting and callback, the WxConnect Script runs a HTTP POST to initial a call back request.
//const sendCallbackWebhook = "https://hooks.us.webexconnect.io/events/K2UQH76CK3"
...
// const dsSASKey = "SharedAccessSignature so=ebb2ea6b-0f66-4e94-9bb2-fafa1c48ff21&sn=CCBOOTCAMP&ss=ds&sp=rw&se=2033-01-28T18:30:46.325Z&sk=CCBOOTCAMPAPP&sig=4GBGJeX9INSI6By6YdqHdCHFm8zbkuV%2F8YAjhd2XREE%3D"

//Put your user name, their email address and phone number here, hard coded for JDS events etc.
const firstName = "Mike"
const lastName = "Brezicky"    
const phone = "+14125199983"
const email = "mbrezick@cisco.com"
const CHJDSProjectID = "64d65fa621a4034e04bc51f9"
const tokenServicePassphrase = "Brezick8683!"
const tokenServiceURL = "https://us-central1-token-service-395918.cloudfunctions.net/token-service?name=sample"
  ...
  const sendSMS = async () => {
    const response = await fetch(sendSMSWelcomeWebhook, {
        ...
        body:JSON.stringify( 
        {
          ...
          balance:"10",
          link:"https://www.seic.com",
          WeclomeMessage:"Here is a link to your options"
        }), // string or object
        headers: {
          'Content-Type': 'application/json',
        }
